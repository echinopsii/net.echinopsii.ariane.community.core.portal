...
/**
 * Define a user preference entity which are registered by CC components into CC Portal user preference section. <br/>
 ...
 *
 * This class implements Comparable in order to help the CC Portal user preference section to sort the registered user preference entity.
 */
