/**
 * Portal base bundle
 * Portal Faces Managed Bean Configuration Tools
...
package net.echinopsii.ariane.community.core.portal.base.tools;
...
/**
 * Helper to register faces managed bean from external plugin jar to a specified web context. Used by faces managed bean registries.
 */
public class FacesMBeanConfig {

    private static final Logger log = LoggerFactory.getLogger(FacesMBeanConfig.class);

    /**
     * register faces managed bean to the servletContext
     *
     * @param facesConfig faces-config.xml URL
     * @param servletContext the target servlet context
     */
    public static void register(URL facesConfig, ServletContext servletContext) {
        Document dom = parseXML(facesConfig);
    ...
    /**
     * unregister faces managed bean from the servletContext
     *
     * @param facesConfig faces-config.xml URL
     * @param servletContext the target servlet context
     *
     ...
     */
    public static void unregister(URL facesConfig, ServletContext servletContext) throws IllegalAccessException, InstantiationException, ClassNotFoundException {
        Document dom = parseXML(facesConfig);
        String namespace = dom.getDocumentElement().getNamespaceURI();
     ...
     */
    private static Document parseXML(URL facesConfig) {
        Document dom = null;
