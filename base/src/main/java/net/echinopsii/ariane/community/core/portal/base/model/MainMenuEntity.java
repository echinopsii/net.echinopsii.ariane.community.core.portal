...
/**
 * A main menu entity is an object which aims to be registered into the Ariane Portal Main Menu Registry.<br/>
 * The fields definitions of this entity are closely linked to the PrimeFaces MenuItem class.<br/><br/>
 *
 * This class implements Comparable in order to help the Ariane Portal Main Menu registry to sort the registered main menu entity.
 *
...
public class MainMenuEntity implements Comparable<MainMenuEntity> {
     ...
     *
     * @param id Identify the main menu entity in the Ariane Portal JSF rendering.<br/>
     *           MUST BE UNIQUE
     * @param value Define the main menu entity value which will be displayed in the final Ariane main menu.<br/>
     *              Used in compareTo implementation.
     * @param contextAddress Define the target link part after scheme, server name and port of the Ariane main menu entity.
