 ...
 * This is used by any Ariane component which needs to register its user preference sections (and so its user preference entities)
...
public class UserPreferencesRegistryImpl implements UserPreferencesRegistry {
    ...
    private static final String USER_PREFERENCES_ITEM_REGISTRY_SERVICE_NAME = "Ariane Portal User Preferences Registry";
