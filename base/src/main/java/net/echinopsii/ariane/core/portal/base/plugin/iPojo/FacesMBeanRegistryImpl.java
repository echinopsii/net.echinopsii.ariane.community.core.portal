...
package net.echinopsii.ariane.core.portal.base.plugin.iPojo;

import net.echinopsii.ariane.core.portal.base.plugin.FacesMBeanRegistry;
import net.echinopsii.ariane.core.portal.base.tools.FacesMBeanConfig;
 ...
 *
 *  This is the iPojo implementation of {@link net.echinopsii.ariane.core.portal.base.plugin.FacesMBeanRegistry} for Ariane portal. The component is instantiated at commons-jsf bundle startup.
 *  It provides the {@link net.echinopsii.ariane.core.portal.base.plugin.FacesMBeanRegistry} service for Ariane portal.
 */
@Component
@Provides
@Instantiate(name="ArianePortalFacesMBeanRegistry")
public class FacesMBeanRegistryImpl implements FacesMBeanRegistry {
    ...
    private static final String PORTAL_FACES_MBEAN_REGISTRY_SERVICE_NAME = "Ariane Portal Faces Managed Bean Registry";
