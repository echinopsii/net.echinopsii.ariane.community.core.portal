...
public class MainMenuEntityRegistryTest {
    ...
    //this.registerMainMenuEntity(new MainMenuEntity("spreadsheetMItem", "Spreadsheet", "#", MenuEntityType.TYPE_MENU_ITEM, 5, "icon-table icon-large"));
        ...
        this.registerMainMenuEntity(new MainMenuEntity("udirectoryMItem", "UserProfile directory", "#", MenuEntityType.TYPE_MENU_ITEM, 71, "icon-beer icon-large").setParent(adminSB));
