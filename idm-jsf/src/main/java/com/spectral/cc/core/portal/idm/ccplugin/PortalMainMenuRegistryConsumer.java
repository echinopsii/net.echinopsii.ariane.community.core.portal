...
@Instantiate
public class PortalMainMenuRegistryConsumer {
    private static final Logger log = LoggerFactory.getLogger(PortalMainMenuRegistryConsumer.class);
    private static PortalMainMenuRegistryConsumer INSTANCE;
    ...
    public void bindMainMenuEntityRegistry(MainMenuEntityRegistry r) {
        log.info("IDM Consumer bound to main menu item registry...");
        mainMenuEntityRegistry = r;
    }

    @Unbind
    public void unbindMainMenuEntityRegistry() {
        log.info("IDM Consumer unbound from main menu item registry...");
     ...
     */
    public synchronized static PortalMainMenuRegistryConsumer getInstance() {
        if (INSTANCE == null) {
            INSTANCE = new PortalMainMenuRegistryConsumer();
        }
        return INSTANCE;
    }
}