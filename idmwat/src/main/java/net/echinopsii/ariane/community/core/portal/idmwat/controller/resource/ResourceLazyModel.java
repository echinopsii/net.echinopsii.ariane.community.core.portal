...
package net.echinopsii.ariane.community.core.portal.idmwat.controller.resource;

import net.echinopsii.ariane.community.core.portal.idmwat.plugin.IDMJPAProviderConsumer;
import net.echinopsii.ariane.community.core.idm.base.model.jpa.Resource;
...
public class ResourceLazyModel extends LazyDataModel<Resource> {
    ...
    private void paginate(int first, String sortField, SortOrder sortOrder, Map<String,String> filters) {
        ...
        query.setHint("org.hibernate.cacheRegion", "ariane.core.idm.cache.queries");
