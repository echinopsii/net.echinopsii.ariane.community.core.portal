    ...
    public void run() {
        ...
        try {
            ...
            */
            ...
            entity = new MainMenuEntity("aboutMItem", "About", MAIN_MENU_PORTAL_CONTEXT + "views/help/about.jsf",
                    MenuEntityType.TYPE_MENU_ITEM, MAIN_MENU_HELP_RANK * 10 + submenuCount++, "icon-info-sign icon-large").setParent(helpSB);
            OsgiActivator.mainPortalMainRightMenuEntityList.add(entity);
            MainMenuRegistryConsumer.getInstance().getMainMenuEntityRegistry().registerMainRightMenuEntity(entity);
