...
import net.echinopsii.ariane.core.portal.wat.plugin.PortalFaceletsResourceResolverServiceConsumer;
 ...
 *      <param-value>net.echinopsii.ariane.core.portal.wat.tools.FaceletsResourceResolver</param-value>
 *  </context-param>
 * </pre>
 */
public class FaceletsResourceResolver extends ResourceResolver {
    ...
    public URL resolveUrl(String path) {
        log.debug("Resolve {} from portal wab...", new Object[]{path});
    ...
    public static URL resolveUrlFromThisJar(String path) {
        log.debug("Resolve {} from portal wat...", new Object[]{path});
