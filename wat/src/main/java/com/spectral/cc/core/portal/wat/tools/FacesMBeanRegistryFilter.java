...
/**
 * This servlet filter is an helper to add new Managed Bean coming from CC plugin to CC servlet context thanks the cc portal plugin faces mbean registry consumer.<br/>
 * It must be configured properly in the web.xml file :<br/><br/>
 * <pre>
 *         <!-- CC Plugin Faces Managed Bean Registry Filter -->
 *         <filter>
 *              <filter-name>CCPluginFacesMBeanRegistryFilter</filter-name>
 *              <filter-class>com.spectral.cc.core.portal.commons.tools.FacesMBeanRegistryFilter</filter-class>
 *         </filter>
 *         <filter-mapping>
 *              <filter-name>CCPluginFacesMBeanRegistryFilter</filter-name>
